...
# Save to CSV
yields_daily_df.round(10).to_csv("q5_yield_levels_5maturities.csv")
...
# Save results
eigvals_y_df.to_csv("q6_yield_eigenvalues.csv")
eigvecs_y_df.to_csv("q6_yield_eigenvectors.csv")

eigvals_f_df.to_csv("q6_forward_eigenvalues.csv")
eigvecs_f_df.to_csv("q6_forward_eigenvectors.csv")
